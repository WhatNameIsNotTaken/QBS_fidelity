...
rho_source_phaseflip=e1*rho_source*e1'+e2*rho_source*e2'+e3*rho_source*e3'+e4*rho_source*e4'+e5*rho_source*e5'+e6*rho_source*e6'+...
...
rho_source_bitflip=e1*rho_source*e1'+e2*rho_source*e2'+e3*rho_source*e3'+e4*rho_source*e4'+e5*rho_source*e5'+e6*rho_source*e6'+...
    e7*rho_source*e7'+e8*rho_source*e8'+e9*rho_source*e9'+e10*rho_source*e10'+e11*rho_source*e11'+e12*rho_source*e12'+e13*rho_source*e13'+...
    e14*rho_source*e14'+e15*rho_source*e15'+e16*rho_source*e16';
...
%% draw the figure, and show the legend of all these 4 noise with its minimum.
...
legend('phase flipping noise','phase flipping noise min','amplitude damping noise','amplitude damping noise min','bit flipping noise','bit flipping noise min','bit flipping noise','bit flipping noise min');
